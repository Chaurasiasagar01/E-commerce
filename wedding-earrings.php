...
<body>
	...
	<section id="advertisement">
		<div class="container">
			<img src="images/shop/wedding-poster.jpg" alt="" />
		</div>
	</section>
			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">WEDDING JEWELLERY</h2>
                        <?php
                                 $cat_sql = "SELECT * FROM `stock` WHERE collection='3' AND type='Earrings'";
